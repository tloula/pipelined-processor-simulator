...
//    System.out.println("Org 0");
      ...
      if (myScanner.hasNext()) {
        ...
        if (myScanner.hasNextInt()) {
          ...
          if (!myScanner.hasNextInt()) {
            ...
            if (dataOffset % 4 != 0) {
                int rem = dataOffset % 4;
                dataOffset = dataOffset + 4 - rem;
  ...
  public Instruction getInstAtAddr(int addr) {
    if (addr % 4 != 0) {
      throw new MIPSException("getInstAtAddr: non-aligned addr = "+addr);
    }
